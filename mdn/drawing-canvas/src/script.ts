...
function runLoop(balls : Ball[]): IO<{}>{
    function loop() {
...
function drawBall(ball: Ball, ctx : CanvasRenderingContext2D): IO<{}> {
...
function edgeDetect(ball: Ball): Ball {
...
function collisionDetect(balls: Ball[]):Ball[] {
...
function initGame(n : number): Ball[]{
    canvas.width = width;
